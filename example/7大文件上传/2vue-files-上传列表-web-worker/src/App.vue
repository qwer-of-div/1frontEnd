<template>
  <div id="app">
    <div class="master-upload-container">
      <Simple ref="upload" :accept="accepts" :limit="limit" :on-exceed="fileLimitFn" :chunk-size="chunkSize"
        :before-upload="beforeUpload" :base-url="baseUrl" :headers="headers" @success="success">
...
export default {
  ...
  methods: {
    ...
    beforeUpload (file) {
      ...
      if (this.uploadType !== '*' && this.acceptsObj[this.uploadType].indexOf(file.type) === -1) {
        this.$notify({

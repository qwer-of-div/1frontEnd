<template>
  <div class="simpel-upload-container">
    <div class="total-progress">
      <div class="btns">
        <el-button-group>
          <el-button :disabled="changeDisabled" icon="el-icon-upload2">选择文件
            <input v-if="!changeDisabled" type="file" :multiple="multiple" class="select-file-input" :accept="accept"
              @change="handleFileChange" />
          </el-button>
          <el-button :disabled="uploadDisabled" @click="handleUpload" icon="el-icon-upload">上传</el-button>
          <el-button :disabled="pauseDisabled" @click="handlePause" icon="el-icon-video-pause">暂停</el-button>
          <el-button :disabled="resumeDisabled" @click="handleResume" icon="el-icon-video-play">恢复</el-button>
          <el-button :disabled="clearDisabled" @click="clearFiles" icon="el-icon-delete">清空</el-button>
        </el-button-group>
  ...
  methods: {
    ...
    calculateHash (fileChunkList) {
      ...
      return new Promise((resolve) => {
        this.worker = new Worker('./worker1/hash-worker.js')

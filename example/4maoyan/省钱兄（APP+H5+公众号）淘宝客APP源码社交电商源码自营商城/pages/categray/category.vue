    ...
    <view class="category-list">
      ...
      <scroll-view scroll-y="true"
        ...
        <view class="category"
          ...
          <view v-for="(box, i) in category.data"
                :key="i">
            ...
            <view class="list"
                  v-if="box.info.length>0">
              <view class="box"
                    v-for="(item, i1) in box.info"
                    :key="i1">
                <image @click="toCategory(item.son_name)"
                       :src="item.imgurl"
                       lazy-load="https://www.gomyorder.cn/logo.png"></image>

<template>
	<view>
		...
		<view class="form-wrap">
			<u-form :model="form" label-width="auto" :error-type="errorType" ref="uForm">
				<u-form-item label="身份证" prop="id">
					<u-input v-model="form.id" border  :trim="false"></u-input>
				</u-form-item>
			</u-form>
				...
				rules: {
					id: [{
						...
						validator: (rule, value, callback) => {
							...
							console.log(this.mixVerify,rule)
							rule.message = this.mixVerify.label
							return this.mixVerify.flag
						},
						message: '提示信息',
						trigger: ['change', 'blur']
					}]

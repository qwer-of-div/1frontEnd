<template>
	<view>
		<uni-navbar :isBack="true" title="goodTabs">
			<template slot="right">
		...
		<view class="wrap">
			<view class="u-tabs-box">
				...
				<u-tabs-swiper activeColor="#f29100" ref="tabs" :list="list" :current="current" @change="change" swiperWidth="750"></u-tabs-swiper>
			</view>
			<view class="flex-col flex1" @touchstart="refreshStart" @touchmove="refreshMove" @touchend="refreshEnd">
				<view class="loading-wrap">
					<uni-refresh ref="refresh" @isRefresh='isRefresh'></uni-refresh>
				</view>
				<view class="swiper-wrap flex-col flex1">

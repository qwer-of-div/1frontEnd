<template>
	<view>
		<uni-navbar :isBack="true" title="threeLogin">
			<template slot="right">
			...
			<view class="login-footer">
				...
				<view class="footer-other flex">
					<view class="other-list">
						<image src="/static/img/common/ic-QQ@2x.png" mode="aspectFill" @tap="login_qq()"></image>
					</view>
					<view class="other-list">
						<image src="/static/img/common/ic-weixin@2x.png" mode="aspectFill" @tap="login_weixin()"></image>
					</view>
				</view>
			</view>
		</view>

<template>
	<view>
		<uni-navbar :isBack="true" title="refresh">
			<template slot="right">
		...
		<view class="wrap">
			<view class="u-tabs-box">
				...
				<u-tabs-swiper activeColor="#f29100" ref="tabs" :list="tabsList" :current="current" @change="change"  swiperWidth="750"></u-tabs-swiper>
			</view>
			<view class="flex-col flex1">
			<uni-good-refresh ref="pullScroll" :back-top="true" :fixed="false" :pullDown="pullDown" :pullUp="loadData">
